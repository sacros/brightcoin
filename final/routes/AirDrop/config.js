...
var config_BrightCoinAirDrop = require(path + "BrightCoinAirDrop.json");

module.exports = {
  abi_BrightCoinAirDrop: config_BrightCoinAirDrop.abi,
  address_BrightCoinAirDrop: config_BrightCoinAirDrop.networks["4"].address,
